...
export default function VehicleCard({ vehicles, onUpdate }) {
  try {
    ...
    return (
      <div data-name="vehicle-card">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold">My Vehicles</h2>
          <button type="button" onClick={() => setShowAddModal(true)} className="btn-primary flex items-center space-x-2">
        ...
        {vehicles.length === 0 ? (
          <div className="bg-white p-12 rounded-xl text-center">
            <div className="icon-car text-5xl text-gray-300 mb-4" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {vehicles.map((vehicle, index) => (
              <div
                ...
                className="bg-white p-6 rounded-xl shadow hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-slideUp"
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <div className="icon-car text-xl text-blue-600" />
                  </div>
                </div>
                <div className="space-y-2 text-sm">
                  <p>
                    <span className="font-semibold">Plate:</span> {vehicle.objectData.PlateNumber}
                  </p>
                  <p>
                    <span className="font-semibold">Mileage:</span>{' '}
                    {vehicle.objectData.Mileage ? vehicle.objectData.Mileage.toLocaleString() : '—'} km
                  </p>
                </div>
              </div>
            ))}
