export default function Hero() {
  try {
    return (
      <section className="relative overflow-hidden py-20 bg-gradient-to-br from-white to-[var(--bg-light)]" data-name="hero">
            ...
            <div className="fade-in">
              ...
              <div className="mt-8 flex items-center space-x-6 text-sm text-[var(--text-light)]">
                <div className="flex items-center space-x-2">
                  <div className="icon-check-circle text-lg text-green-600" />
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-xl shadow-lg">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                    <div className="icon-calendar-check text-xl text-green-600" />
                  </div>
                  <div>
