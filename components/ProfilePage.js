function ProfilePage() {
  try {
    ...
    const [stats, setStats] = React.useState({ vehicles: 0, maintenance: 0, spent: 0 });
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow p-8 mb-6 hover:shadow-lg transition-shadow duration-300">
          <div className="flex items-center space-x-6 mb-6">
            ...
            <button className="px-6 py-2 border-2 border-[var(--primary-color)] text-[var(--primary-color)] rounded-lg font-semibold hover:bg-[var(--primary-color)] hover:text-white transition-all">Edit Profile</button>
          </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-3 border-b">
              <div className="flex items-center space-x-3">
                <div className="icon-moon text-xl text-gray-600"></div>
            ...
            <a href="#" className="flex items-center justify-between py-3 border-b hover:bg-gray-50 transition-colors">
              <div className="flex items-center space-x-3">
                <div className="icon-help-circle text-xl text-gray-600"></div>
            ...
            <a href="#" className="flex items-center justify-between py-3 border-b hover:bg-gray-50 transition-colors">
              <div className="flex items-center space-x-3">
                <div className="icon-shield text-xl text-gray-600"></div>
        ...
        <button onClick={handleLogout} className="w-full bg-[var(--primary-color)] text-white py-3 rounded-lg font-semibold hover:opacity-90 transition-all">Logout</button>
      </div>
    );
  } catch (error) {
