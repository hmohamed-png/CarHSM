      ...
      <footer className="bg-[var(--secondary-color)] text-white py-12" data-name="footer" data-file="components/Footer.js">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="marketplace.html" className="hover:text-white transition-colors">Marketplace</a></li>
                <li><a href="fuel-tracking.html" className="hover:text-white transition-colors">Fuel Tracking</a></li>
                <li><a href="traffic-fines.html" className="hover:text-white transition-colors">Traffic Fines</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2025 UCarX. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
